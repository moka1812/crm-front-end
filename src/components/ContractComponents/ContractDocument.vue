    ...
    >
      ...
      <template v-slot:items="props">
        <tr>
          ...
          <td class="text-xs-center content">
            <v-btn class="btn-download" @click="downloadItem(props.item.link)">
                <i class="material-icons">file_download</i>
            </v-btn>
            <!-- <a :href=" downloadItem(props.item.link)" download>
               <i class="material-icons">file_download</i>
            </a> -->
            <!-- <a @click.prevent="downloadItem(props.item.link)" :href="props.item.link">
              <i class="material-icons">file_download</i>
            </a> -->
          </td>
          <td class="text-xs-center content">
  ...
  data() {
    return {
      headers: [
        ...
        {
          text: "Download", value: "download", align: 'center', sortable: false, class: "header"
        },
        {
